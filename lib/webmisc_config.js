(function() {
    ...
    // "Do not use RequireJS' paths option to configure the path to
    // CodeMirror, since it will break loading submodules through relative
    // paths. Use the packages configuration option instead..."
    ...
    var cfg = {
        ...
        paths: {
            ...
            "es6-loader":             baseUrl + "requirejs-babel-es6",
        ...
        packages: [
            { name: "codemirror", location: baseUrl + "codemirror-5", main: "lib/codemirror", },
            // Note: To get extra CodeMirror features, application requires these:
            //    "codemirror-5/lib/codemirror"
