// Borrowed and adapted from: https://github.com/mikach/requirejs-babel/blob/master/es6.js
// Adapted in the following ways: Upgrade from Babel-5 to Babel-6. Support .jsx extension.
    ...
    return {
        load: function (name, req, onload, config) {
            ...
            function applyOptions(options) {
                var defaults = {
                    //modules: 'amd', // in Babel-5, not in Babel-6, see: http://babeljs.io/docs/plugins/#modules
                    sourceMap: config.isBuild ? false :'inline',
                    sourceFileName: name + '.jsx',
